...
.overlay {
    ...
    right: 0;
    bottom: 0;
    background-color: rgba(0, 0, 0, 0.65); /* Overlay sombre plus prononcé */
    display: flex;
    justify-content: center;
    align-items: center;
    flex-direction: column;
...
.badge-judo { background-color: #d32f2f; color: white; }
.badge-aikido { background-color: #1976d2; color: white; }
.badge-jujitsu { background-color: #388e3c; color: white; }
.badge-judo-detente { background-color: #fbc02d; color: black; }
.badge-unknown { background-color: #757575; color: white; }

/* Judo */
.btn-outline-judo { border: 2px solid #d32f2f; color: #d32f2f; }
.btn-outline-judo:hover { background-color: #d32f2f; color: white; }

/* Aïkido */
.btn-outline-aikido { border: 2px solid #1976d2; color: #1976d2; }
.btn-outline-aikido:hover { background-color: #1976d2; color: white; }

/* Jujitsu */
.btn-outline-jujitsu { border: 2px solid #388e3c; color: #388e3c; }
.btn-outline-jujitsu:hover { background-color: #388e3c; color: white; }

/* Judo détente */
.btn-outline-judo-detente { border: 2px solid #fbc02d; color: #fbc02d; }
.btn-outline-judo-detente:hover { background-color: #fbc02d; color: black; }

/* Discipline inconnue */
.btn-outline-unknown { border: 2px solid #757575; color: #757575; }
.btn-outline-unknown:hover { background-color: #757575; color: white; }
...
@media (max-width: 767.98px) {
    ...
    .actu-secondaire-card .col-5, .actu-secondaire-card .col-7 {
        width: 100%;
    }
}
</style>
