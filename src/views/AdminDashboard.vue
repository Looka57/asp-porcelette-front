...
import TresorerieDashboard from '@/components/DashboardAdmin/TresorerieDashboard.vue';

Chart.register(...registerables);

const authStore = useAuthStore();
const isTresoriere = computed(() =>
...
<template>
  <div class="py-5 px-3 md:px-6 surface-ground min-vh-100 text-white">
    ...
    <TresorerieDashboard v-if="isTresoriere" />
